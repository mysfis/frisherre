    ...
    <Container p={{ xs: 2, sm: 3, md: 4 }} className={classes.timeline}>
      ...
      <Grid container className={classes.gridList}>
        {profiles.map(profile => (
          <Grid item key={JSON.stringify(profile)} xs={6} sm={4} md={3} className={classes.gridItem}>
            <Box className={classes.card}>
              <Box 
                ...
                <Box className={classes.actions}>
                  ...
                  <IconButton aria-label="play/pause" onClick={()=> handleEdit(profile)}>
                    <EditIcon className={classes.icon}/>
                  </IconButton>
                  <IconButton aria-label="next" onClick={()=> handleDelete(profile)}>
